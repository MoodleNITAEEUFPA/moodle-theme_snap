...
$string['courseformatnotification'] = 'Formát aktuálního kurzu, který používáte, není motivem Snap plně podporován. Blackboards pro nejlepší práci s kurzem doporučuje používat s motivem Snap formát kurzu Témata nebo Týdně. Formát kurzu lze změnit v <a href="{$a}">nastavení kurzu</a>.';
...
$string['customcssdesc'] = 'Upozorňujeme, že velké možnosti provází velká zodpovědnost. Pokud přidáním kódu CSS zde vznikne jakýkoli problém, bude na vás, abyste ho vyřešili. Podpora Blackboards neřeší problémy s obsahem týkajícím se kódu CSS ani k němu neposkytuje podporu.';
...
$string['knowledgebase'] = 'Znalostní báze Blackboards';
$string['list'] = 'Seznam';
...
$string['poweredbyrunby'] = 'Sestaveno pomocí <a href="http://moodlerooms.com/" target="_blank">Blackboards</a>,
