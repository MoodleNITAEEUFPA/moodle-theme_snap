...
$string['customcssdesc'] = 'Non bisogna dimenticare che avere ampio potere porta ampie responsabilità.  Rientra quindi nelle tue responsabilità risolvere qualsiasi problema causato da codice CSS inserito qui.  Il supporto tecnico di Blackboards non si occupa della risoluzione dei problemi, né fornisce assistenza in merito ai contenuti relativi a codice CSS.';
...
$string['knowledgebase'] = 'Knowledge Base di Blackboards';
$string['list'] = 'Lista';
...
$string['poweredbyrunby'] = 'Generato con <a href="http://www.blackboard.com/" target="_blank">Blackboards</a>,
...
$string['warnsiteformatflexpage'] = 'Il sito utilizza Flexpage nella pagina iniziale. Flexpage non è ottimizzato per i dispositivi con schermo ridotto. È consigliato disattivare l\'uso di Flexpage nelle <a href="{$a}">impostazioni della pagina iniziale</a> affinché il sito si adatti all\'uso sui dispositivi mobili.';
