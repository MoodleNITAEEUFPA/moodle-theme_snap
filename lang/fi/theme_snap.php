...
$string['courseformatnotification'] = 'Nykyinen kurssimuoto ei täysin tue Snap-teemaa. Parhaan mahdollisen käyttökokemuksen varmistamiseksi Blackboards suosittelee Aiheet- tai Viikoittain-kurssimuodon käyttämistä Snap-teeman kanssa. Kurssimuotoa voi vaihtaa <a href="{$a}">kurssin asetuksissa</a>.';
...
$string['customcssdesc'] = 'Muista, että tehokkailla muokkaustoiminnoilla voi tehdä myös merkittäviä virheitä. Sinun täytyy itse korjata kaikki virheet, jotka johtuvat tässä lisäämästäsi CSS:stä. Blackboardsin tuki auta CSS:ään liittyvän sisällön vianmäärityksessä.';
...
$string['knowledgebase'] = 'Blackboards-tietämyskanta';
...
$string['poweredbyrunby'] = 'Kehitetty <a href="http://moodlerooms.com/" target="_blank">Blackboardsilla</a>,
