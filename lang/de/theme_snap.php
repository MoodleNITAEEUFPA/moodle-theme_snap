...
$string['courseformatnotification'] = 'Das momentan von Ihnen genutzte Kursformat wird nicht vollständig vom Snap-Thema unterstützt. Für eine bestmögliche Erfahrung empfiehlt Blackboards die Kursformate "Themen" oder "Wöchentlich" mit dem Snap-Thema. Das Kursformat kann unter <a href="{$a}">Kurseinstellungen</a> geändert werden.';
...
$string['customcssdesc'] = 'Bitte berücksichtigen Sie, dass größere Befugnis auch größere Verantwortlichkeit mit sich bringt. Die Behebung aller Probleme, die von dem hier hinzugefügten CSS stammen, liegt in Ihrer Verantwortung. Der Support von Blackboards behebt keine Probleme im Zusammenhang mit CSS-Inhalt und stellt dafür auch keine Hilfe bereit.';
...
$string['poweredbyrunby'] = 'Entwickelt mit <a href="http://moodlerooms.com/" target="_blank">Blackboards</a>,
...
$string['warnsiteformatflexpage'] = 'Auf der Startseite Ihrer Site wird Flexpage verwendet. Flexpage ist für Geräte mit kleinen Anzeigen nicht optimiert. Wenn Sie Ihre Seite besser auf mobile Geräte einstellen möchten, sollten Sie Flexpage unter <a href="{$a}">Startseiteneinstellungen</a> deaktivieren.';
