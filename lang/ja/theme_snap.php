...
$string['courseformatnotification'] = '現在お使いのコース形式はSnap themeでは完全にサポートされていません。Blackboardsで最高のエクスペリエンスを実現するには、Snap themeのトピックまたは週次コースの形式を使用することをお勧めします。コース形式は<a href="{$a}">コース設定</a>で変更できます。';
...
$string['customcssdesc'] = '大きな力には大きな責任が伴うことに注意してください。ここで追加されたCSSによって問題が生じた場合、あなたが解決する責任があります。BlackboardsサポートはCSS関連のコンテンツに関してトラブルシューティングやヘルプを提供しません。';
...
$string['knowledgebase'] = 'Blackboardsナレッジベース';
$string['list'] = 'リスト';
...
$string['poweredbyrunby'] = '<a href="http://moodlerooms.com/" target="_blank">Blackboards</a> (<a href="http://www.moodle.com/" target="_blank">Moodle</a>提供) で構築しています。<br>
