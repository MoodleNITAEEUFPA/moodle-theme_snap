...
$string['courseformatnotification'] = 'Snap 主題無法完整支援您目前使用的課程格式。為了享有最佳使用體驗，Blackboards 建議您針對 Snap 主題使用「主題」或「每週」課程格式。您可以在「<a href="{$a}">課程設定</a>」中變更課程格式。';
...
$string['customcssdesc'] = '請注意，掌握越大的權力，也意味著承擔更大的責任。您須負責解決這裡新增的 CSS 所造成的任何問題。Blackboards 支援不對 CSS 相關內容進行疑難排解，亦不提供任何協助。';
...
$string['knowledgebase'] = 'Blackboards 知識庫';
$string['list'] = '清單';
...
$string['poweredbyrunby'] = '採用 <a href="http://moodlerooms.com/" target="_blank">Blackboards</a> 建置，
