...
$string['courseformatnotification'] = 'Aktualnie używany format kursu nie jest w pełni obsługiwany przez kompozycję Snap. W celu uzyskania najlepszych rezultatów Blackboards zaleca stosowanie z kompozycją Snap formatów kursu Tematy lub Tygodniowy. Format kursu można zmienić w <a href="{$a}">ustawieniach kursu</a>.';
...
$string['knowledgebase'] = 'Baza wiedzy Blackboards';
$string['list'] = 'Lista';
...
$string['poweredbyrunby'] = 'Zbudowane z użyciem <a href="http://moodlerooms.com/" target="_blank">Blackboards</a>,
...
$string['warnsiteformatflexpage'] = 'Strona Flexpage stanowi stronę główną Twojej witryny. Strony Flexpage nie są zoptymalizowane pod kątem wyświetlania na ekranie niewielkich urządzeń. Zaleca się wyłączyć stosowanie formatu stron Flexpage w <a href="{$a}">ustawieniach strony głównej</a>, aby ułatwić obsługę witryny na urządzeniach mobilnych.';
