...
$string['courseformatnotification'] = 'تنسيق المقرر الدراسي الحالي الذي تستخدمه غير مدعوم بالكامل بواسطة النسق "محاذاة". لأفضل الممارسات، يوصي Blackboards باستخدام "الموضوعات" أو "تنسيقات الأسبوع للمقرر الدراسي" مع النسق "محاذاة". يمكن تغيير تنسيق المقرر الدراسي في <a href="{$a}">إعدادات المقرر الدراسي</a>.';
...
$string['customcssdesc'] = 'يرجى العلم أن القدرات الكبيرة يصاحبها مسؤولية كبيرة. لذا فإن أي مشكلة تحدث بسبب إضافة CSS هنا يقع على عاتقك مسؤولية حلها. لا يقوم دعم Blackboards باستكشاف المشكلات وإصلاحها ولا يقوم بتقديم أي مساعدة بشأن المحتوى المتعلق بـ CSS.';
...
$string['knowledgebase'] = 'قاعدة معارف Blackboards';
$string['list'] = 'قائمة';
...
$string['poweredbyrunby'] = 'مدمج مع <a href="http://moodlerooms.com/" target="_blank">Blackboards</a>،
...
$string['warnsiteformatflexpage'] = 'يستخدم موقعك Flexpage في الصفحة الأمامية. Flexpage غير محسَّن للأجهزة صغيرة الشاشات. من المستحسن أن تقوم بتعطيل استخدام Flexpage في <a href="{$a}">إعدادات الصفحة الأمامية</a> الخاصة بك إن كنت تريد أن يكون موقعك متوافقًا مع الأجهزة المحمولة.';
