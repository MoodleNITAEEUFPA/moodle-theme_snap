...
$string['courseformatnotification'] = 'Het huidige cursusformaat dat je gebruikt, wordt niet volledig ondersteund door het thema Snap. Voor de beste ervaring beveelt Blackboards aan dat je de onderwerpen of wekelijkse cursusindelingen met het thema Snap gebruikt. Je kunt de cursusindeling wijzigen in de <a href="{$a}">cursusinstellingen</a>.';
...
$string['customcssdesc'] = 'Wees je van je verantwoordelijkheid bewust. Elk probleem dat wordt veroorzaakt door de CSS die hier wordt toegevoegd, moet je zelf oplossen. Blackboards Support kan je niet helpen met CSS-inhoud.';
...
$string['poweredbyrunby'] = 'Gebouwd met <a href="http://www.blackboard.com/" target="_blank">Blackboards</a>,
