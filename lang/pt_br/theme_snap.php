...
$string['customcssdesc'] = 'Saiba que com grande poder vem grande responsabilidade. Você é responsável pela solução de qualquer problema causado pelo CSS adicionado aqui. O Suporte do Blackboards não soluciona nem oferece nenhuma ajuda para o conteúdo relacionado ao CSS.';
...
$string['knowledgebase'] = 'Base de conhecimento do Blackboards';
$string['list'] = 'Lista';
...
$string['poweredbyrunby'] = 'Criado com o <a href="http://moodlerooms.com/" target="_blank">Blackboard Open LMS</a>, modificado por CITE/NITAE², 
    desenvolvido com <a href="http://www.moodle.com/" target="_blank">Moodle</a>.<br>                                                                                                                                            
    Copyright &#169; '.date('Y').' Blackboard Inc. Todos os direitos reservados.';
