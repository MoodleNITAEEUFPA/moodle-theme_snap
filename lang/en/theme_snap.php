...
$string['courseformatnotification'] = 'The current course format you are using is not fully supported by the Snap theme. For the best experience Blackboards recommends using the Topics or Weekly course formats with the Snap theme. The course format can be changed in the <a href="{$a}">course settings</a>.';
...
$string['customcssdesc'] = 'Please be aware that with great power comes great responsibility.  Any issue caused by the CSS added here is your responsibility to resolve.  Blackboards Support does not troubleshoot nor provide any help with CSS-related content.';
...
"56":"#CC0087",<br>
"89":"#CCF084"}';
$string['knowledgebase'] = 'Blackboards Knowledge Base';
$string['list'] = 'List';
